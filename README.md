...
## Non-functional Requirements:
 - React and Redux implementation. You are free to use any Redux middlewares you prefer
 - Basic unit test coverage. We don’t want to see 100% test coverage, but we do want you to showcase your approach to testing
 - Clean UI. Our applications require strong usability and we are looking for people with an eye for good UX. Show us what you can do.You may use any boilerplate you want to quickly bootstrap the application. Bonus points for using styled components.
